...
<head>
    ...
    <link rel="stylesheet" href="<?= BASEURL; ?>/css/intern-style.css">
</head>
    ...
    <div id="wrapper">
        <nav id="sidebar">
            <div class="sidebar-header">
                <a href="<?= BASEURL; ?>/intern/dashboard" class="text-decoration-none d-flex align-items-center">
                    ...
                    <div class="line-height-1">
                        ...
                        <small class="text-success extra-small fw-bold text-uppercase">Portal Magang</small>
                    </div>
                </a>
            </div>
            ...
            <div class="sidebar-content">
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="<?= BASEURL; ?>/intern/dashboard" class="<?= (strpos($current_page, 'intern/dashboard') !== false) ? 'active' : ''; ?>">
                            <i class="bi bi-house-door"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>

                    <li class="nav-label text-uppercase">Aktivitas</li>
                    <li>
                        <a href="<?= BASEURL; ?>/intern/attendance" class="<?= ($data['active_menu'] ?? '') == 'attendance' ? 'active' : ''; ?>">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown">
                                ...
                                <div class="d-none d-md-block line-height-1">
                                    <span class="text-dark small fw-bold text-capitalize d-block"><?= $_SESSION['name']; ?></span>
                                    <small class="text-muted extra-small">Mahasiswa Magang</small>
                                </div>
                            </a>
